...
import com.Cat_themed_coffee.common.exception.user.UserPasswordNotMatchException;
import com.Cat_themed_coffee.common.exception.user.UserPasswordRetryLimitExceedException;
...
public class CustomerPasswordService
{
    ...
    public void validate(Customer user)
    {
    ...
    public boolean matches(Customer user, String rawPassword)
    {
