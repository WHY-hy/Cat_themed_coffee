      ...
      <el-row :gutter="20">
         ...
         <el-col :span="24" :xs="24">
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
               ...
               <el-table-column label="头像" align="center" key="avatar" v-if="columns[3].visible" width="100">
...
const data = reactive({
   ...
   rules: {
      userName: [{ required: true, message: "用户名称不能为空", trigger: "blur" }, { min: 2, max: 12, message: "用户账号长度必须介于 2 和 20 之间", trigger: "blur" }],
      nickName: [{ required: true, message: "用户账号不能为空", trigger: "blur" }, { min: 2, max: 20, message: "用户名称长度必须介于 8 和 12 之间", trigger: "blur" }],
...
function handleAvatarUpload(avatarUrl) {
   form.value.newAvatar = avatarUrl;
}
